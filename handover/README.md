...
**One-line state:** the anomaly register is **1**, down from 210. **The ordinance and rules lanes are both at zero.** It is committed, gated
on CI, and **matches a live three-lane run on this machine** — acts 1, rules 0, ordinance 0,
...
|---|---|---|---|---|
| `section_carries_its_body` | 1 | — | — | **1** |
| **per lane** | **1** | **0** | **0** | **1** |

Trajectory: `210 → 193 → 148 → 92 → 78 → 75 → 70 → 64 → 50 → 44 → 33 → 30 → 30 → 34 → 34 → 32 → 29 → 25 → 25 → 25 → 22 → 13 → 12 → 10 → 9 → 6 → 1`.
