...
**One-line state:** the anomaly register is **6**, down from 210. **The ordinance and rules lanes are both at zero.** It is committed, gated
on CI, and **matches a live three-lane run on this machine** — acts 6, rules 0, ordinance 0,
...
|---|---|---|---|---|
| `section_carries_its_body` | 6 | — | — | **6** |
| **per lane** | **6** | **0** | **0** | **6** |

Trajectory: `210 → 193 → 148 → 92 → 78 → 75 → 70 → 64 → 50 → 44 → 33 → 30 → 30 → 34 → 34 → 32 → 29 → 25 → 25 → 25 → 22 → 13 → 12 → 10 → 9 → 6`.
